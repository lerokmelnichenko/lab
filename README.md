...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=coverage)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=bugs)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Duplicated Lines (%)](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=duplicated_lines_density)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=lerokmelnichenko_lab&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=lerokmelnichenko_lab)
